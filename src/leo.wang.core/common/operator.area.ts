...
/**
 * Get the all citys of province
 * @param province Provice name
 * @returns all of citys of province contains district and country
 */
function getCitysByProvince(province: string) {
  let citys: object[] = [];
 ...
 * @param city Current City's name
 * @param provice_citys All of citys in the province
 * @returns all of districts of the city
 */
function getDistrictByCity(city: string, provice_citys: Array<object>) {
  let districts: object[] = [];
  provice_citys.forEach((element: any) => {
    if (element.name === city) {
      districts = element.districtAndCounty;
    }
  });
  return districts;
}
...
/**
 * Get all citys of china
 * @returns All of citys of china
 */
function getAllCitys(): Array<string> {
  const citys: string[] = [];
  areas.forEach((element: any) => {
    element.city.forEach((el: any) => {
      citys.push(el.name);
    });
  });
  return citys;
...
export { getCitysByProvince, getDistrictByCity, getAllCitys };
